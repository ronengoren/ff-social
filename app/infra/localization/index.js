...
import {updateMomentLocale} from '../utils/dateTimeUtils';
import {
...
import {
  ...
  getTranslatedName,
} from '../../screens/signup/JoinCommunity/countries';
...
class Localization {
  init() {
    ...
    I18n.missingTranslation = (scope) => {
      ...
      const missingTranslationLocales = Object.keys(translations)
        .filter((t) => translations[t] === undefined)
        .join(',');

      //   Logger.info({
      //     message: `Missing ${missingTranslationLocales} translation for ${scope}`,
      //     key: scope,
      //     locale,
      //     translations
      //   });
