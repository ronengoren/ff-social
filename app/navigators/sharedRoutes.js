...
const sharedRoutes = {
  ...
  //           ? 'profile.entities_in_location.from_header'
  //           : 'profile.entities_in_location.around_header',
  //         {name},
  //       );
  //       return {
  ...
  //     navigationOptions: ({navigation}) => {
  //       const title =
  //         navigation.state.params.pageName ||
  //         I18n.t('savers_and_followers.title');
  //       return {
  //         header: (
  //           <Header
  //             hasBackButton
  //             title={title}
  //             backgroundColor={flipFlopColors.blueberry}
  //             titleColor={flipFlopColors.white}
  //             buttonColor="white"
  //           />
  //         ),
  //       };
  ...
  //         ? I18n.t('profile.profile_groups_list.own_header')
  //         : I18n.t('profile.profile_groups_list.header', {name});
  //       return {
  //         header: (
  //           <Header
  //             hasBackButton
  //             title={title}
  //             rightComponent={screens.ProfileGroupsList.renderCreateButton()}
  //           />
  //         ),
  //       };
  //     },
  ...
  //       const name = possesify(user.name);
  //       const title = isOwnProfile
  //         ? I18n.t('profile.profile_pages_list.own_header')
  //         : I18n.t('profile.profile_pages_list.header', {name});
  //       return {
  //         header: (
  //           <Header
  //             hasBackButton
  //             title={title}
  //             rightComponent={screens.ProfilePagesList.renderCreateButton()}
  //           />
  //         ),
  //       };
  //     },
